 ...
 */
public class PerfectNumberInCommandType {
    public static void main(String[] args){
        Scanner in = new Scanner(System.in);
        System.out.println("使用命令式模式实现：");
        ...
        boolean isPerfect = new ImpNumberClassifierSimple(number).isPerfect();
        boolean isAbundant = new ImpNumberClassifierSimple(number).isAbundant();
        boolean isDeficient = new ImpNumberClassifierSimple(number).isDeficient();
